...
public class Ex01_Array {
	public static void main(String[] args) {
		...
		//		생성할때 바드시 크기를 지정해야 한다.
		// 		한번 지정된 크기는 변경되지 않는다.
		//		배열 데이터를 추출할때는 일반적으로 for문을 사용
		// 배열의 종류 : -1차원 배열과 다차원 배열(배열안에 배열이 존재)
		//			  -기본자료형배열과 참조자료형배열(객체배열) 두가지로 나눠짐)
		...
		//			new 예약어 : 메모리에 데이터를 저장 할 공간을 만들어라
		//						=> 인스턴스, 객체 생성
		su = new int[4];
		...
		// 				배열 전체에 대해서 정보 추력 및 가공 가능
		//				그러나 특정 몇개나 특정 하나를 별도로 출력하거나 가공할 수 없다.
		//				인덱스값을 이용할 수 없다.
